  ...
  return (
    <div className="w-full max-w-48">
      <div className="relative">
        <select
          className="block w-full rounded-xl border-2 border-white/20 bg-white/90 backdrop-blur-md px-4 py-3 pr-4 text-sm font-medium shadow-lg
          ...
          disabled={disabled}
        >
          <option value="">{disabled ? "Cargando..." : "Seleccioná una ciudad…"}</option>
          {cities.map(c => (
